...
bps = list(map(parse_blueprint, open('inputs/day_19_input.txt').read().split('\n')))
print("First Star:",sum((i + 1) * largest_for_bp(bp, 24) for i, bp in enumerate(bps)))
print("Second Star:",math.prod(largest_for_bp(bp, 32) for bp in bps[:3]))
